...
//   console.log(prices, "Prices in Card title"); // Debugging: check the value of prices
...
//   return (
//     <div
//       className="max-w-sm rounded-xl overflow-hidden w-[90%] h-full shadow-lg relative mx-auto cursor-pointer"
...
//           prices.length > 0 &&
//           prices[0].amount != null
//             ? `From HKD $${prices[0].amount.toFixed(2)}`
//             : "Price not available"}
//         </p>
//       </div>
//       <div className="bg-[#F8F8F8] w-full absolute bottom-0">
//         {/* Rating and review display */}
//         <div className="flex flex-row gap-2 ml-3 mt-4 items-center">
...
export default function AccomodationCard({
  ...
  const handleCardClick = () => {
    if (id) {
      router.push(`/wild-accomodation/${id}`);
    } else {
      console.error("ID is undefined");
    }
  };
  ...
  return (
    <div
      ...
      onClick={handleCardClick}
    >
      <div className="relative w-[232px] h-[131px]">
        <Image
          className="object-cover"
          src={images[0]?.url || owl}
          alt={title}
          fill
        />
      </div>
