...
export default function CardSection4() {
  ...
  console.log(accomodation, "its all data of accomodations..");
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      setShowControls(accomodation.length > visibleItems);
    };
                    ...
                    >
                      <div className="p-1">
                        <AccomodationCard
                          ...
                          images={accommodation?.images || []} // Pass the array of images
