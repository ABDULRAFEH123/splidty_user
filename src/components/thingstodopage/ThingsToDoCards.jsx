...
//   console.log(itineraries.prices, "its all the prices..");

//   // useEffect(() => {
//   //   console.log("STATED,,,");
//   //   if (itineraries.prices == null) {
//   //     setPrices(itineraries.prices);
//   //     console.log(prices, "itrs finally..");
//   //   } else {
...
//               prices={itinerary.prices || [1, 2]} // Ensure prices is passed correctly
//             />
//           ))}
//         </div>
    ...
    <div className="setCenter bg-[#F8F8F8] mt-10">
      <div className="w-[85%] 2xl:w-[70%]">
        ...
        <div className="flex flex-row">
          ...
          <div
            className="flex flex-row gap-2 absolute right-14 lg:right-32 2xl:right-56 text-xs mt-4 options cursor-pointer"
            onClick={() => {
              setShowAll(true);
              setActiveTag(null);
            }}
